...
public class MultiDimensionalArray {
    public static void main(String[] args) {
        ...
        // Dimensi 1 yang indeksnya 0 memili panjang elemen 2
        arrChar[0][0] = 'A';
        arrChar[0][1] = 'B';

        // Dimensi 1 yang indeksnya 1 memili panjang elemen 3
        arrChar[1][0] = 'C';
        arrChar[1][1] = 'D';
        arrChar[1][2] = 'E';
        ...
        System.out.println("Dimensi 1 dengan indeks 1 dan Dimensi 2 dengan indeks 1 : " + arrChar[1][2]);
